...
def ploteo(nombres,nombres1):
    ...
    Nmax=8192
    DTMENS=50.406370500000776
    DTMCAL=92.40906489999907
    dtmE=[]
    dtmC=[]
    for n in N:
        dtmE.append(DTMENS)
    ...
    for nombre in nombres: #Este va a ir cambiando
        ...
        plt.title("Complejidad algoritimica de INV Dispersa")
    ...
    plt.savefig("Grafico INV Dispersa.png", bbox_inches="tight")
    #plt.show()
    
nombres=["Ensamblado_INV_Disp.txt"]
nombres1=["Calculo_INV_Disp.txt"]
