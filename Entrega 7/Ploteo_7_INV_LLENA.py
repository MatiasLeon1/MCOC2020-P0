...
def ploteo(nombres,nombres1):
    ...
    Nmax=8192
    DTMENS=49.50117240000145
    DTMCAL=365.64207929999975
    dtmE=[]
    dtmC=[]
    for n in N:
        dtmE.append(DTMENS)
    ...
    for nombre in nombres: #Este va a ir cambiando
        ...
        plt.title("Complejidad algoritimica de INV llena")
    ...
    plt.savefig("Grafico INV llena.png", bbox_inches="tight")
    #plt.show()
    
nombres=["Ensamblado_INV_Llena.txt"]
nombres1=["Calculo_INV_Llena.txt"]
