...
def ploteo(nombres,nombres1):
    ...
    Nmax=8192
    DTMENS=125.66423340000074
    DTMCAL=0.02931189999981143
    dtmE=[]
    dtmC=[]
    for n in N:
        dtmE.append(DTMENS)
    ...
    for nombre in nombres: #Este va a ir cambiando
        ...
        plt.title("Complejidad algoritimica de MATMUL Dispersa")
    ...
    plt.savefig("Grafico MATMUL Disp.png", bbox_inches="tight")
    #plt.show()
    
nombres=["Ensamblado_MATMUL_Disp.txt"]
nombres1=["Calculo_MATMUL_Disp.txt"]
