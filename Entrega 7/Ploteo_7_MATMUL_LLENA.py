...
def ploteo(nombres,nombres1):
    ...
    Nmax=8192
    DTMENS=94.05448830000023
    DTMCAL=223.10317299999952
    dtmE=[]
    dtmC=[]
    for n in N:
        dtmE.append(DTMENS)
    ...
    for nombre in nombres: #Este va a ir cambiando
        ...
        plt.title("Complejidad algoritimica de MATMUL llena")
    ...
    plt.savefig("Grafico MATMUL llena.png", bbox_inches="tight")
    #plt.show()
    
nombres=["Ensamblado_MATMUL_Llena.txt"]
nombres1=["Calculo_MATMUL_Llena.txt"]
