...
def ploteo(nombres,nombres1):
    ...
    Nmax=8192
    DTMENS=49.30810179999935
    DTMCAL=0.04376889999912237
    dtmE=[]
    dtmC=[]
    for n in N:
        dtmE.append(DTMENS)
    ...
    for nombre in nombres: #Este va a ir cambiando
        ...
        plt.title("Complejidad algoritimica de SOLVE Dispersa")
    ...
    plt.savefig("Grafico SOLVE Disp.png", bbox_inches="tight")
    #plt.show()
    
nombres=["Ensamblado_SOLVE_Disp.txt"]
nombres1=["Calculo_SOLVE_Disp.txt"]
