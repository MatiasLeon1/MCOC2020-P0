# -*- coding: utf-8 -*-
"""
Created on Wed Aug 12 16:50:43 2020
...
def Matriz_Laplaciana(N, dtype=np.double):
...
DT23=[]
Memoria=[]
archivo=open("Iteracion_double.txt","w")  #Guarde 4 archivos para los 4 tipos
for i in N:                               #Half
    ...
    t032=perf_counter()
    dt03=t032-t031
    size=2*(i**2)*64 #Cambie el calculo dependiendo del tipo.
