# -*- coding: utf-8 -*-
"""
Created on Mon Aug 10 17:08:05 2020
...
def Matriz_Laplaciana(N, dtype=np.half):
...
DT23=[]
Memoria=[]
archivo=open("Iteracion_half.txt","w")    #Guarde 4 archivos para los 4 tipos
for i in N:                               #Half
    ...
    t032=perf_counter()
    dt03=t032-t031
    size=2*(i**2)*16 #Cambie el calculo dependiendo del tipo.
